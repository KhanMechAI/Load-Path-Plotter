...
%      singleton*.
%
%      H = LOADPATHGUI returns the handle to a new LOADPATHGUI or the handle to
...
% Last Modified by GUIDE v2.5 19-Jan-2018 00:37:14
...
helpmessage = ...
    ...
    'two or three dimensional. The default setting will be 3D.'...
    ];
...
helpmessage = ...
    ['This option allows the user to overlay several load path plots on a single figure. '...
    'Turn this option on so that subsequent outputs will be overlayed.'
    ];
h = helpdlg(helpmessage, 'Overlaying Plots');
...
% handles    structure with handles and user data (see GUIDATA)
    ...
    overlay = handles.checkbox4.Value;
    ...
    loadpath3D(dimension,sim_dir, seed_dir, save_dir, model_name,path_dir,...
